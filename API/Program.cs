...
using Stripe;
using System.Text;
using Customer = FoodDelivery.Data.Models.Customer;
using CustomerService = FoodDelivery.Core.Services.CustomerService;
using Product = FoodDelivery.Data.Models.Product;
using ProductService = FoodDelivery.Core.Services.ProductService;
